...
Thank you for your help improving **Skeleton**!

**Skeleton** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **Skeleton** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/sphinxcontrib-skeleton
   cd sphinxcontrib-skeleton
...
This will install the **Skeleton** library, together with two additional tools:
